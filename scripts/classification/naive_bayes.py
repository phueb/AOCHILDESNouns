...
# accuracy is better for both partitions with naive bayes when normalization
tw_mat1 = normalize(tw_mat1, axis=1, norm='l2', copy=False)
tw_mat2 = normalize(tw_mat2, axis=1, norm='l2', copy=False)
