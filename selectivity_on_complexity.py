...
from wordplay.util import split, split_into_sentences
from wordplay.co_occurrence import make_context_by_term_matrix
...
probe_store = ProbeStore('childes-20191112_terms', PROBES_NAME, prep1.store.w2id, excluded=excluded)
...
if ADD_SEM_PROBES:
    added_probes = ProbeStore('childes-20191112_terms', 'sem-all', prep1.store.w2id, excluded=excluded).types.copy()
